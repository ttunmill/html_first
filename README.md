...
---
### semantic tag란?
* HTML5에서 의미적인 태그로 div가 아닌 정해져있는 태그로 레이아웃을 구성해야한다.
### header
...
---
## dl, dt, dd 정희형 목록태그
* `dl`은 정희형 제목과 내용을 묶는 그룹입니다.
* `dt`는 dl안 자식으로 배치되며 제목을 의미하고 dd 기준 항상 먼저 시작합니다.
* `dd`는 dl안 자식으로 배치되며 dt의 다음 형제 요소로 배치되거나 기존 dd의 형제로도 배치될 수 있습니다.